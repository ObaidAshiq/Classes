...
app.use(feedRoutes)
// const connwctToMongoDB=async()=>{
//    const res = await mongoose.connect('mongodb+srv://ubisage:Cisco123@classes.e4n9b.mongodb.net/?retryWrites=true&w=majority&appName=classes')
// }
